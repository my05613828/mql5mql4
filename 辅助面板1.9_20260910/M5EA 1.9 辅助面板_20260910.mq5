...
int OnInit()
  {
   ...
   图形.画矩形标签("矩形",0,10,75,300,500,BORDER_FLAT,背景色,STYLE_SOLID,clrBlack,1,CORNER_LEFT_UPPER,false,false,false);
   画面板();
...
//---左上角
   图形.画文本标签("币种",0,10,100,ANCHOR_LEFT_UPPER,CORNER_LEFT_UPPER,0,Symbol(),"Microsoft YaHei",(int)(font20*font_percent),clrGainsboro,false,false);
   ...
   图形.画文本标签("BID",0,10,160,ANCHOR_LEFT_UPPER,CORNER_LEFT_UPPER,0,"BID:"+DoubleToString(BID,Digits()),"Microsoft YaHei",(int)(font12*font_percent),clrGreen,false,false);
   ...
   图形.画文本标签("price_lots",0,10,15+330,ANCHOR_LEFT_UPPER,CORNER_LEFT_UPPER,0,"多均价:"+DoubleToString(long_peice_mean,Digits())+"  "+long_lots+" "+"空均价:"+DoubleToString(short_peice_mean,Digits())+"  "+short_lots,"Microsoft YaHei",(int)(font10*font_percent),clrWhite,false,false);
   图形.画文本标签("profit",0,10,65+330,ANCHOR_LEFT_UPPER,CORNER_LEFT_UPPER,0,"多盈亏:"+long_profit+" "+" 空盈亏:"+short_profit+" 总盈亏:"+profit,"Microsoft YaHei",(int)(font10*font_percent),clrWhite,false,false);
...
void 画面板()
  {
   ...
   图形.画按钮("magic_number",0,10,75,100,25,CORNER_LEFT_UPPER,"magic_num",clrBlue,clrBlack,clrWhite,"Microsoft YaHei",(int)(font15*font_percent),false,false,false);
   图形.画编辑框("magic",0,110,75,100,25,false,CORNER_LEFT_UPPER,"1",clrAliceBlue,clrGreen,clrBlack,"Microsoft YaHei",(int)(font12*font_percent),ALIGN_CENTER,false,false,false);
...
//---
   图形.画按钮("卖",0,110,100,100,55,CORNER_LEFT_UPPER,"卖出/SELL",clrGreen,clrBlack,clrWhite,"Microsoft YaHei",(int)(font15*font_percent),false,false,false);
   图形.画按钮("买",0,210,100,100,55,CORNER_LEFT_UPPER,"买入/BUY",clrRed,clrBlack,clrWhite,"Microsoft YaHei",(int)(font15*font_percent),false,false,false);
   图形.画按钮("修改止损",0,110,160,100,20,CORNER_LEFT_UPPER,"修改止损",clrGreen,clrBlack,clrWhite,"Microsoft YaHei",(int)(font15*font_percent),false,false,false);
   图形.画按钮("修改止盈",0,210,160,100,20,CORNER_LEFT_UPPER,"修改止盈",clrRed,clrBlack,clrWhite,"Microsoft YaHei",(int)(font15*font_percent),false,false,false);
//---手数  止损  止盈
...
//---减仓  删挂
   图形.画按钮("多减仓",0,10,260,101,25,CORNER_LEFT_UPPER,"多减仓",clrGreen,clrBlack,clrRed,"Microsoft YaHei",(int)(font13*font_percent),false,false,false);
   图形.画按钮("空减仓",0,10,10+280,101,25,CORNER_LEFT_UPPER,"空减仓",clrGreen,clrBlack,clrWhite,"Microsoft YaHei",(int)(font13*font_percent),false,false,false);
...
//---
   ...
   图形.画按钮("锁仓",0,10,20+301,99,20,CORNER_LEFT_UPPER,"锁仓",clrWhite,clrBlack,clrBlack,"Microsoft YaHei",(int)(font15*font_percent),false,false,false);
   图形.画按钮("保本",0,110,20+301,99,20,CORNER_LEFT_UPPER,"保本",clrWhite,clrBlack,clrBlack,"Microsoft YaHei",(int)(font15*font_percent),false,false,false);
   图形.画按钮("删挂",0,210,20+301,99,20,CORNER_LEFT_UPPER,"删除挂单",clrWhite,clrBlack,clrBlack,"Microsoft YaHei",(int)(font15*font_percent),false,false,false);
//---
   图形.画按钮("平多",0,10,22+340,80,30,CORNER_LEFT_UPPER,"平多",clrRed,clrBlack,clrWhite,"Microsoft YaHei",(int)(font15*font_percent),false,false,false);
   图形.画按钮("平空",0,80,22+340,80,30,CORNER_LEFT_UPPER,"平空",clrGreen,clrBlack,clrWhite,"Microsoft YaHei",(int)(font15*font_percent),false,false,false);
   图形.画按钮("全平",0,150,22+340,80,30,CORNER_LEFT_UPPER,"全平",clrBlue,clrBlack,clrWhite,"Microsoft YaHei",(int)(font15*font_percent),false,false,false);
   图形.画按钮("清仓",0,230,22+340,80,30,CORNER_LEFT_UPPER,"清仓",clrGainsboro,clrBlack,clrBlack,"Microsoft YaHei",(int)(font15*font_percent),false,false,false);


//---
   图形.画按钮("平多指定盈利",0,10,20+413,100,30,CORNER_LEFT_UPPER,"平多指定盈利",clrGreen,clrBlack,clrRed,"Microsoft YaHei",(int)(font12*font_percent),false,false,false);
   ...
   图形.画文本标签("盈",0,10,60+413,ANCHOR_LEFT_UPPER,CORNER_LEFT_UPPER,0,"多盈             "+"空盈              "+"净盈 ","Microsoft YaHei",(int)(font13*font_percent),clrGainsboro,false,false);
   图形.画文本标签("触",0,10,60+413+30,ANCHOR_LEFT_UPPER,CORNER_LEFT_UPPER,0,"多价             "+"空价              "+"净价 ","Microsoft YaHei",(int)(font13*font_percent),clrGainsboro,false,false);
   图形.画文本标签("追",0,10,60+413+30+30,ANCHOR_LEFT_UPPER,CORNER_LEFT_UPPER,0,"多追             "+"空追         ","Microsoft YaHei",(int)(font13*font_percent),clrGainsboro,false,false);

   图形.画编辑框("盈多",0,50,60+410,58,25,false,CORNER_LEFT_UPPER,"0",clrGainsboro,clrWhite,clrBlack,"Microsoft YaHei",(int)(font12*font_percent),ALIGN_CENTER,false,false,false);
   图形.画编辑框("盈空",0,151,60+410,58,25,false,CORNER_LEFT_UPPER,"0",clrGainsboro,clrWhite,clrBlack,"Microsoft YaHei",(int)(font12*font_percent),ALIGN_CENTER,false,false,false);
   图形.画编辑框("净盈",0,251,60+410,58,25,false,CORNER_LEFT_UPPER,"0",clrGainsboro,clrWhite,clrBlack,"Microsoft YaHei",(int)(font12*font_percent),ALIGN_CENTER,false,false,false);

   图形.画编辑框("触多",0,50,60+410+30,58,25,false,CORNER_LEFT_UPPER,"0",clrGainsboro,clrWhite,clrBlack,"Microsoft YaHei",(int)(font12*font_percent),ALIGN_CENTER,false,false,false);
   图形.画编辑框("触空",0,151,60+410+30,58,25,false,CORNER_LEFT_UPPER,"0",clrGainsboro,clrWhite,clrBlack,"Microsoft YaHei",(int)(font12*font_percent),ALIGN_CENTER,false,false,false);
   图形.画编辑框("触总",0,251,60+410+30,58,25,false,CORNER_LEFT_UPPER,"0",clrGainsboro,clrWhite,clrBlack,"Microsoft YaHei",(int)(font12*font_percent),ALIGN_CENTER,false,false,false);

   图形.画编辑框("均多",0,50,60+410+30+30,58,25,false,CORNER_LEFT_UPPER,"0",clrGainsboro,clrWhite,clrBlack,"Microsoft YaHei",(int)(font12*font_percent),ALIGN_CENTER,false,false,false);
   图形.画编辑框("均空",0,151,60+410+30+30,58,25,false,CORNER_LEFT_UPPER,"0",clrGainsboro,clrWhite,clrBlack,"Microsoft YaHei",(int)(font12*font_percent),ALIGN_CENTER,false,false,false);


   图形.画按钮("移除",0,10,50+450+60,300,25,CORNER_LEFT_UPPER,"移除面板",clrRed,clrBlack,clrWhite,"Microsoft YaHei",(int)(font15*font_percent),false,false,false);

//---响应栏
   图形.画编辑框("响应栏",0,10,20+390,298,18,false,CORNER_LEFT_UPPER,"财货浑浑如泉源，汸汸如河海",clrAliceBlue,clrGainsboro,clrBlack,"Microsoft YaHei",(int)(font12*font_percent),ALIGN_CENTER,false,false,false);
